...
public class Math3d : MonoBehaviour {
    ...
    public static bool ClosestPointsOnTwoLines(out Vector3 closestPointLine1, out Vector3 closestPointLine2, Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2, Vector3 lineVec2){
        ...
        if(Mathf.Approximately(d, 0.0f) == false){
    ...
    public static float ScreenDistanceToLine(Vector3 linePoint1, Vector3 linePoint2, Vector2 screenPosition, Camera cam)
    {
        Vector3 screenPos1 = cam.WorldToScreenPoint(linePoint1);
        Vector3 screenPos2 = cam.WorldToScreenPoint(linePoint2);
        Vector3 projectedPoint = ProjectPointOnLineSegment(screenPos1, screenPos2, (Vector3)screenPosition);
        Vector3 vector = (Vector2)projectedPoint - screenPosition;
